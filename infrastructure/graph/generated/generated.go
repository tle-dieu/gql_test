...
func (ec *executionContext) _Ad_options(ctx context.Context, field graphql.CollectedField, obj *model.Ad) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalOOptions2ᚖgithubᚗcomᚋtleᚑdieuᚋad_graphql_apiᚋinfrastructureᚋgraphᚋgeneratedᚋmodelᚐOptions(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalInputAdInput(ctx context.Context, obj interface{}) (model.AdInput, error) {
	...
	for k, v := range asMap {
		...
		case "options":
			...
			it.Options, err = ec.unmarshalOOptionsInput2ᚖgithubᚗcomᚋtleᚑdieuᚋad_graphql_apiᚋinfrastructureᚋgraphᚋgeneratedᚋmodelᚐOptionsInput(ctx, v)
			if err != nil {
				return it, err
			}
		}
...
func (ec *executionContext) unmarshalInputOptionsInput(ctx context.Context, obj interface{}) (model.OptionsInput, error) {
	...
	for k, v := range asMap {
		...
		case "bluetooth":
			...
			ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("bluetooth"))
...
func (ec *executionContext) unmarshalNAdInput2githubᚗcomᚋtleᚑdieuᚋad_graphql_apiᚋinfrastructureᚋgraphᚋgeneratedᚋmodelᚐAdInput(ctx context.Context, v interface{}) (model.AdInput, error) {
...
func (ec *executionContext) marshalOOptions2ᚖgithubᚗcomᚋtleᚑdieuᚋad_graphql_apiᚋinfrastructureᚋgraphᚋgeneratedᚋmodelᚐOptions(ctx context.Context, sel ast.SelectionSet, v *model.Options) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
...
func (ec *executionContext) unmarshalOOptionsInput2ᚖgithubᚗcomᚋtleᚑdieuᚋad_graphql_apiᚋinfrastructureᚋgraphᚋgeneratedᚋmodelᚐOptionsInput(ctx context.Context, v interface{}) (*model.OptionsInput, error) {
	if v == nil {
		return nil, nil
	}
